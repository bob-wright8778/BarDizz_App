...
/// Text-shadow auras layered behind an accent-colored number or label.
class AppGlow {
  const AppGlow._();

  static final barDown = [
    Shadow(color: AppColors.iceBluePrimary.withValues(alpha: 0.6), blurRadius: 16),
    Shadow(color: AppColors.iceBluePrimary.withValues(alpha: 0.35), blurRadius: 32),
  ];
}
